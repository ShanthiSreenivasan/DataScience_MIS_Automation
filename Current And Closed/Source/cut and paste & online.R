...
#browser()
  ...
  body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service for your account with ${accounts$Lender_Name}<br/><br/>You had subscribed for the above referenced service with CreditMantri. As part of this process we have already contacted your lender. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address in order to furnish the details on your account. We request you to cut and paste the below mentioned text and send it to the lender (${accounts$Email}) from your registered email address. Kindly retain the subject line. Please copy us as cc in your email - care@creditmantri.com <br/> <br/> <b>Kindly ignore this mail if you have already sent the below text to the lender.</b><br/><br/>Please forward us any responses that you have received or you may receive from the bank to care@creditmantri.com to further proceed with your account resolution.<br/>')
