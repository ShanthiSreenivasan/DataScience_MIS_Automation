...
#     
#     body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>This is regarding the Credit Improvement Services that you had subscribed to earlier, to resolve issues in your credit report with respect to the referenced account.<br/>')
#     
...
if (nrow(Reminder_1)>0) {
  ...
  lapply(Reminder_dump1$CISserialno, function(lead){
    ...
    body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>We had sent you an email a few days ago regarding your subscription to the Credit Improvement Service (Credit Fit Program) with CreditMantri. We are following-up to remind you, Since we have not heard from you. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com <br/> <br/><b>Kindly ignore this mail if you have already sent the below text to the lender.</b><br/><br/>Please forward us any responses that you have received or you may receive from the bank to care@creditmantri.com to further proceed with your account resolution.<br/>')
...
if (nrow(Reminder_2)>0) {
  ...
  lapply(Reminder_dump2$CISserialno, function(lead){
    ...
    body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>This is our  <b>2nd reminder </b>regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri. We have not yet received confirmation from you regarding sending out the email to your lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com<br/><br/><b>Kindly ignore this mail if you have already sent the below text to the lender.</b><br/><br/>We request you to forward to us any responses that you have received or you may receive from the lender to care@creditmantri.com to further proceed with your account resolution. <br/>')
...
if (nrow(Reminder_3)>0) {
  ...
  lapply(Reminder_dump3$CISserialno, function(lead){
    ...
    body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>This is our <b>3rd reminder </b>regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri. We have not yet received confirmation from you regarding sending out the email to your lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We had requested you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com.<br/> <br/><b>Kindly ignore this mail if you have already sent the below given text to the bank.</b><br/><br/>We request you to forward to us any responses that you have received or you may receive from the lender to care@creditmantri.com to further proceed with your account resolution.<br/>')
...
if (nrow(o2CReminder_1)>0) {
  ...
  lapply(o2CReminder_dump1$CISserialno, function(lead){
    ...
    body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>We had sent you an email a few days ago regarding your subscription to the Credit Improvement Service with CreditMantri (Credit Fit Program). We are following-up to remind you, Since we have not heard from you. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com <br/><br/>Please forward us any responses that you have received or you may receive from the bank to care@creditmantri.com to further proceed with your account resolution.<br/>')
    
    body2 <- str_interp('<br/><br/>---------------------------------------Cut Here---------------------------------------<br/> <br/>  Dear Sir/Madam, <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>  I had sent an email a few days ago that on a scrutiny of my Equifax bureau report, I observe that the referenced account has been reported with a 30-59 days past due status in the repayment history. This is hindering my ability to avail fresh loans and I would like to know what needs to be done to update the account status as CLOSED/STANDARD. I need your assistance to resolve this issue with the bureau and help me become loan eligible. <br/><br/>Thanks and Regards <br/>${accounts$Customer_Name}')
...
if (nrow(o2CReminder_2)>0) {
  ...
  lapply(o2CReminder_dump2$CISserialno, function(lead){
    ...
    body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>This is our  <b>2nd 02CReminder </b>regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri and we have sent to lender. We have not yet received confirmation from lender regarding sending out the email to your lender and hence this 02CReminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com <br/><br/>We request you to forward to us any responses that you have received or you may receive from the lender to care@creditmantri.com to further proceed with your account resolution.')
    
    body2 <- str_interp('<br/><br/>---------------------------------------Cut Here---------------------------------------<br/> <br/>  Dear Sir/Madam, <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>  I had sent two emails a few days ago and since I have not heard from you, I am following up to remind you that on scrutiny of my Equifax bureau report, I observe that the referenced account has been reported with a 30-59 days past due status in the repayment history. This is hindering my ability to avail fresh loans and I would like to know what needs to be done to update the account status as CLOSED/STANDARD. I need your assistance to resolve this issue with the bureau and help me become loan eligible. <br/><br/>Thanks and Regards <br/>${accounts$Customer_Name}')
...
if (nrow(o2CReminder_3)>0) {
  ...
  lapply(o2CReminder_dump3$CISserialno, function(lead){
    ...
    body1 <- str_interp('<br/>Dear ${accounts$Customer_Name},<br/><br/>Ref : Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>This is our <b>3rd 02CReminder </b>regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri. We have not yet received confirmation from lender and hence this 02CReminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We had requested you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com. <br/><br/>We request you to forward to us any responses that you have received or you may receive from the lender to care@creditmantri.com to further proceed with your account resolution.')
    
    body2 <- str_interp('<br/><br/>---------------------------------------Cut Here---------------------------------------<br/> <br/>  Dear Sir/Madam, <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>  This is my third Reminder about the email that I had sent earlier too and since I have not heard from you, I am following up to remind you that on scrutiny of my Equifax bureau report, I observe that the referenced account has been reported with a 30-59 days past due status in the repayment history. This is hindering my ability to avail fresh loans and I would like to know what needs to be done to update the account status as CLOSED/STANDARD. I need your assistance to resolve this issue with the bureau and help me become loan eligible. <br/>I have not received any response to my previous mails to you. Request you to please help with urgent closure. <br/><br/>Thanks and Regards <br/>${accounts$Customer_Name}')
