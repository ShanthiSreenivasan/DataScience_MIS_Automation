...
o2CFEsc_data <-paste("./Input/02C_FINAL_ESCALATION_",date1,".CSV",sep = '')

o2CFEsc <-fread(o2CFEsc_data) %>% select('lead_id') 
o2CFEsc$lead_id <-as.numeric(o2CFEsc$lead_id)
...
if (nrow(Escalation_1)>0) {
  ...
  lapply(Escalation_dump1$CISserialno, function(lead){
    ...
    email_body <- str_interp('Dear ${accounts$Customer_Name},<br/> <br/>
                           ...
                           Ref :  Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/>
                           
                           We had sent you four emails a few days ago regarding your subscription to the Credit Improvement Service (Credit Fit Program) with CreditMantri and requested you to forward the same to your lender. We are following-up to remind you, Since we have not heard from the lender yet. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender (${accounts$Email}) from your registered email address. Please copy us as CC in your email - care@creditmantri.com<br/><br/>
                           ...
                           <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}
                           ...
                           I request you to let me know the status of the account and the outstanding amount, if any, to be paid by me OR let me know the best way to change the status of the account to CLOSED/STANDARD in my credit report.
...
if (nrow(Escalation_2)>0) {
  ...
  lapply(Escalation_dump2$CISserialno, function(lead){
    ...
    message  <- str_interp('Ref :  Escalation Email 2 - ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}')
    
    # email_body <- str_interp(' Dear ${accounts$Customer_Name} <br/> <br/>Ref: Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name} 
    #                          <br/> <br/>This is our 2nd reminder regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri and we have sent to the lender. We have not yet received confirmation from the lender regarding sending out the email to your lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender ${accounts$Email}from your registered email address. Please copy us as CC in your email - care@creditmantri.com
    ...
    #                          <br/> <br/><br/>---------------------------------------Cut Here--------------------------------------
    #                          <br/> <br/>Sir / Madam, <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>I had earlier sent four emails requesting for an update however have still not received it.
    ...
    #                          <br/> <br/>If I do not receive any response from you, I will be forced to take the issue to the Banking Ombudsman for resolution.<br/><br/>
    #                          <br/> <br/>Thanks and Regards<br/>${accounts$Customer_Name}<br/>
    #                          <br/> <br/><br/>---------------------------------------Cut Here--------------------------------------
    ...
    email_body <- str_interp('Dear ${accounts$Customer_Name}, <br/> <br/>
                           ...
                           <br/> <br/>We have sent few reminders regarding the Credit Improvement Service that you had subscribed to with CreditMantri and we have sent to the lender. We have not yet received confirmation from the lender regarding sending out the email to your lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender (${accounts$Email}) from your registered email address. Please copy us as CC in your email - care@creditmantri.com
                           ...
                           If I do not receive any response from you, I will be forced to take the issue to the Banking Ombudsman for resolution.<br/><br/>
...
if (nrow(Escalation_3)>0) {
  ...
  lapply(Escalation_dump3$CISserialno, function(lead){
    ...
    message  <- str_interp('Ref :  Escalation Email 3 - ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}')
    
    # email_body <- str_interp('Dear ${accounts$Customer_Name}<br/> <br/>Ref:Subscription to our Credit Improvement Service (Credit Fit Program) for your account with${accounts$Lender_Name}<br/><br/>We have sent few reminders to the lender regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri. We have not yet received confirmation from the lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We had requested you to cut and paste the below provided text and send it to the lender( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com.<br/><br/>We request you to forward to us any responses that you have received or you may receive from the lender to care@creditmantri.com to further proceed with your account resolution.<br/><br/><br/>---------------------------------------Cut Here--------------------------------------<br/> <br/>
    #                          Sir / Madam, <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>This is my sixth reminder about the email that I had sent earlier too and since I have not heard from you, I am following up to remind you that on a scrutiny of my Equifax bureau report, I observe that the referenced account has been reported with a 60-89 days past due status in the repayment history. This is hindering my ability to avail fresh loans and I would like to know what needs to be done to update the account status as CLOSED/STANDARD. I need your assistance to resolve this issue with the bureau and help me become loan eligible.
    ...
    email_body <- str_interp('Dear ${accounts$Customer_Name},
                           ...
                           <br/> <br/>We have sent few reminders to the lender regarding the Credit Improvement Service that you had subscribed to with CreditMantri. We have not yet received confirmation from the lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We had requested you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com.
                           ...
                           <br/> <br/>I have not received any response to my previous mails to you. Request you to please help with urgent closure else I will be forced to approach the RBI and Banking ombudsman seeking intervention.<br/><br/>
...
if (nrow(FEscalation)>0) {
  ...
  FilePath <- paste('./Output/',thisDate,"\\Escalation/o2CFINAL Escalation Email - ",thisDate,'.xlsx',sep='')
  FileCreate <- FileCreation(NewLeads,FilePath)
  ...
  lapply(FEscalation_dump3$CISserialno, function(lead){
    ...
    message  <- str_interp('Ref :  Final Escalation Email - ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}')
    
    #   email_body <- str_interp('Dear ${accounts$Customer_Name}<br/> <br/>Ref:Subscription to our Credit Improvement Service (Credit Fit Program) for your account with${accounts$Lender_Name}<br/><br/>This is our 3rd reminder to the lender regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri. We have not yet received confirmation from the lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We had requested you to cut and paste the below provided text and send it to the lender( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com.<br/><br/>We request you to forward to us any responses that you have received or you may receive from the lender to care@creditmantri.com to further proceed with your account resolution.<br/><br/><br/>---------------------------------------Cut Here--------------------------------------<br/> <br/>
    #                            Sir / Madam, <br/> <br/>Subject: ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}<br/><br/>This is my sixth reminder about the email that I had sent earlier too and since I have not heard from you, I am following up to remind you that on a scrutiny of my Equifax bureau report, I observe that the referenced account has been reported with a 60-89 days past due status in the repayment history. This is hindering my ability to avail fresh loans and I would like to know what needs to be done to update the account status as CLOSED/STANDARD. I need your assistance to resolve this issue with the bureau and help me become loan eligible.
    #                            <br/><br/>I have not received any response to my previous mails to you. Request you to please help with urgent closure else I will be forced to approach the RBI and Banking ombudsman seeking intervention.<br/><br/>Thanks and Regards<br/><br/>${accounts$Customer_Name}<br/>
    #                            <br/><br/>---------------------------------------Cut Here--------------------------------------<br/><br/>Kindly forward any response/feedback that you may receive from them.<br/><br/>Thanks and Regards<br/>CreditMantri Team')<br/>
    # 
    # #recipients <- accounts$Email
    
    email_body <- str_interp('Dear ${accounts$Customer_Name},

                             <br/><br/>Ref :  Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}
                             
                             <br/><br/>We have sent many reminders to the lender regarding the Credit Improvement Service (Credit Fit Program) that you had subscribed to with CreditMantri. We have not yet received confirmation from lender and hence this reminder. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purpose, they have requested an email from your registered E-Mail address to furnish the details on the account. We had requested you to cut and paste the below provided text and send it to the lender ( ${accounts$Email} ) from your registered email address. Please copy us as CC in your email - care@creditmantri.com.
...
if (nrow(o2CEscalation_1)>0) {
  ...
  lapply(o2CEscalation_dump1$CISserialno, function(lead){
    ...
    email_body <- str_interp(' Dear ${accounts$Customer_Name}, <br/> <br/>Ref: Subscription to our Credit Improvement Service (Credit Fit Program) for your account with ${accounts$Lender_Name}<br/><br/> We had sent you four emails a few days ago regarding your subscription to the Credit Improvement Service (Credit Fit Program) with CreditMantri and requested you to forward the same to your lender. Since we have not heard from the lender yet, we are following-up to remind you. We had contacted your lender to seek the amount due on your account. As part of their information security policy and for audit purposes, they have requested an email from your registered E-Mail address to furnish the details on the account. We request you to cut and paste the below provided text and send it to the lender ${accounts$Email} from your registered email address. Please copy us as CC in your email - care@creditmantri.com <br/><br/>Please forward us any responses that you have received or you may receive from the bank to care@creditmantri.com to further proceed with your account resolution.<br/><br/>---------------------------------------Cut Here---------------------------------------
                           <br/><br/>Dear Sir / Madam, <br/> <br/>Subject: Escalation Email 1 - ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No} <br/><br/> This is with regards to above mentioned account that has been reported with a ${accounts$Account_status} status in the repayment history with the Equifax Credit Bureau. <br/><br/>I have tried to contact your service desk via email to understand what needs to be done in order to rectify this negative reporting, but have not received any response from them despite my numerous reminders. I am therefore bringing this to your attention anticipating a speedy revert.<br/><br/>I request you to let me know the status of the account and the outstanding amount, if any, to be paid by me OR let me know the best way to change the status of the account to CLOSED/STANDARD in my credit report.<br/><br/>If I do not receive any response from you I will be forced to report the issue to the Banking Ombudsmen in order to seek resolution.<br/><br/>
                           Thanks and Regards<br/>
                           ${accounts$Customer_Name}<br/><br/>
...
if (nrow(o2CEscalation_2)>0) {
  ...
  lapply(o2CEscalation_dump2$CISserialno, function(lead){
    ...
    message  <- str_interp('Ref :  02CEscalation Email 2 - ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}')
...
if (nrow(o2CEscalation_3)>0) {
  ...
  lapply(o2CEscalation_dump3$CISserialno, function(lead){
    ...
    message  <- str_interp('Ref :  02CEscalation Email 3 - ${accounts$Lender_Name} ${accounts$Account_type} ${accounts$Account_No}')
...
o2CFEscalation <- dump %>% filter(CISserialno %in% o2CFEsc$lead_id)

o2CFEscalation<-o2CFEscalation%>% filter(Facilitystatus == "02C  Customer sent Cut and Paste to Lender", LDB == "No" & prodstatus %in% c("CIS-WP-LD-220","CIS-WP-LP-310"))

LeadsNotFound_o2CFEsc <-o2CFEsc %>% filter(!lead_id  %in% o2CFEscalation$CISserialno)

if (nrow(o2CFEscalation)>0) {
  
  
  
  o2CFEscalation <- o2CFEscalation %>% select('CISserialno','Date','Customer_Name','Lender_Name','Account_type','Account_No',
                                              'Account_status','Facilitystatus','Email_Id','Phone_Number','Address','PAN','dob','Product_Status',
                                              'LDB','Flag')
  ...
  o2CFEsc_dump3 <- left_join(o2CFEscalation, product_family,
                             by = c('Account_type' = 'account_type')) %>% 
    mutate(`bank name and product short code` = paste(Lender_Name,product_family_short)) %>% 
    left_join(email_list, by = c('bank name and product short code' = 'lender.name')) %>% 
    distinct(CISserialno, .keep_all = T)
  ...
  o2CFEscalation_no_mail_id_3 <- o2CFEsc_dump3[is.na(o2CFEsc_dump3$Email),]
  o2CFEscalation_dump3 <- o2CFEsc_dump3[!is.na(o2CFEsc_dump3$Email),] %>% distinct(CISserialno, .keep_all = T)
  
  NewLeads <- o2CFEscalation_dump3
  FilePath <- paste('./Output/',thisDate,"\\o2CEscalation/o2CFINAL Escalation Email - ",thisDate,'.xlsx',sep='')
  FileCreate <- FileCreation(NewLeads,FilePath)
  
  
  lapply(o2CFEscalation_dump3$CISserialno, function(lead){
    
    #browser()
    accounts <- o2CFEscalation_dump3[o2CFEscalation_dump3$CISserialno == lead,]
    ...
    email_body <- str_interp('Dear ${accounts$Customer_Name},
                             ...
                             <br/><br/>This is my final reminder about the email that I had sent earlier too and since I have not heard from you, I have not received any response to my previous mails to you. Request you to please help with urgent closure.  I am bringing this to your attention and also expect a reply within next one week failing which I will be left with no choice than to escalate further to ombudsman and related authorities.<br/><br/>
    ...
    print(paste("02C Final Escalation-",accounts$CISserialno))
  ...
  o2CFEscalation_no_mail_id_3 <-o2CFEscalation
  o2CFEscalation_dump3 <-o2CFEscalation
  
  NewLeads <- o2CFEscalation
  FilePath <- paste('./Output/',thisDate,"\\o2CEscalation/FINAL Escalation Email_No Leads found - ",thisDate,'.xlsx',sep='')
  FileCreate <- FileCreation(NewLeads,FilePath)
...
addWorksheet(wb,"o2CFINAL Escalation")
...
setColWidths(wb,"o2CFINAL Escalation",cols = 1:ncol(o2CFEscalation_no_mail_id_3),widths = 15)
writeData(wb,"o2CFINAL Escalation",o2CFEscalation_no_mail_id_3,borders = "all",headerStyle = hs1)
...
setColWidths(wb,"o2CFINAL Escalation",cols = 1:ncol(LeadsNotFound_o2CFEsc),widths = 15)
writeData(wb,"o2CFINAL Escalation",LeadsNotFound_o2CFEsc,borders = "all",headerStyle = hs1)
...
o2CFEsc_up3 <-o2CFEscalation %>% select('CISserialno') %>% mutate(`Facility Status`="02C  Customer sent Cut and Paste to Lender",`CRM Status`="02C Final Escalation Email",Comment="02C Final Escalation Sent to customer",
                                                                  `Allocation Status`="Nil",`Alternate Acc No`="Nil")


o2CEscaltion_up1 <-rbind(o2CEsc_up1,o2CEsc_up2,o2CEsc_up3,o2CFEsc_up3)
